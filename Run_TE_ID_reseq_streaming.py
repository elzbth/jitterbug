...
def run_jitterbug_streaming(psorted_bamfile_name, verbose, te_annot, \
    ...
    if not mem: 
        args1 = ["samtools", "view", "-bh" , "-F", "3854", "-o" , filtered_bam_file_name , psorted_bamfile_name ]
        args2 = ["samtools", "index", psorted_bamfile_name]
    ...
    #     # sys.exit(1) 
        ...
        iterations = 1000000
        input_bam_reader = BamReader(psorted_bamfile_name, output_prefix)
        (isize_mean, isize_sdev, rlen_mean, rlen_sdev) = input_bam_reader.calculate_mean_sdev_isize(iterations)
