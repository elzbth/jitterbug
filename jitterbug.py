...
def main(argv):
    ...
    parser.add_argument("--streaming", help="assume that the input bam file is mounted, and save intermediate filtered read subsets", action="store_true")
    ...
    if args.streaming and not (args.output_prefix and args.conf_lib_stats):
        parser.error("error: if --streaming is set, --output_prefix and --conf_lib_stats must be too")
    ...
    if args.streaming:
        run_jitterbug_streaming(args.mapped_reads, args.verbose, args.TE_annot, te_seqs, \
            ...
            args.numCPUs, args.bin_size, args.minMAPQ, generate_test_bam, args.keep_temp, args.conf_lib_stats, mem, args.min_cluster_size)
