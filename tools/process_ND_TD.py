...
def main(argv):
    ...
    parser.add_argument("--TD_F", help="file in gff3 format of TEI (generated by Jitterbug) in TUMOR sample, FILTERED")
    parser.add_argument("--ND", help="file in gff3 format of TEI (generated by Jitterbug) in NORMAL sample, NOT FILTERED")
    parser.add_argument("-b", "--ND_bam", help="bam file of mapped reads from NORMAL sample")
